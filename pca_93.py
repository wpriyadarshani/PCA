...
class fcm(object):
    ...
    def __init__(self, k=3, max_PCA_iterations=15, min_distance=5.0, size=512, m=1.5, epsilon=.5, max_FCM_iterations=5):
    ...
    def run(self, image):
        ...
        while self.shouldExitFCM(iterations) is False:
            ...
            print "HELLO I A AM FCM ITERATIONS:", iterations
            print"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
    ...
    def update_degree_of_membershipPCA(self):
        ...
        for idx in range(self.k):
            ...
            for i in range(self.s):
                ...
                updated_membership_degree = 1.0/factor
    ...
    def showClustering(self):
        ...
        for idx, pixel in enumerate(self.pixels):
            ...
            #     localPixels[idx]=[0,255,0]
            # elif nearest == self.clusters[1]:
            #     localPixels[idx] = [255,0,0]
        ...
        plt.imsave("PCA_93_1.png", colourMap)


if __name__ == "__main__":
    image = Image.open("G0510772.jpg")
    f = fcm()
    result = f.run(image)
